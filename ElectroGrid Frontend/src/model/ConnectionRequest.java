        ...
        try {
         ...
         // Prepare the html table to be displayed
            ...
            while(rs.next()) {
				...
				output += "<tr><td><input id= 'hidConnReqIdUpdate' name = 'hidConnReqIdUpdate' type='hidden' value= '" + connReqId
						+ "'>"+ nicNo + "</td>";
				...
				// buttons
				output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-secondary' data-connectionRequest_id='"
						+ connReqId + "'>" + "</td>"
